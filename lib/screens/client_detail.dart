...
class _ClientDetailScreenState extends State<ClientDetailScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      if (mounted) setState(() => _error = 'تعذّر تحميل كشف الحساب. حاول مجدداً.');
    } finally {
  ...
  String _formatAt(String? at) {
    if (at == null) return '—';
    try {
      final dt = DateTime.parse(at).add(const Duration(hours: 2));
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                FilledButton.icon(
                  onPressed: (_loading || balanceMinor <= 0) ? null : _showReceiptDialog,
                                ...
                                child: DataTable(
                                  ...
                                  rows: _entries.map((entry) {
                                    ...
                                    return DataRow(cells: [
                                      ...
                                      DataCell(Text(_kindLabel(entry))),
                                      DataCell(SizedBox(
                                        width: 160,
                                        child: Text(
                                          '${entry['notes'] ?? ''}'.isEmpty
                                      ...
                                      DataCell(Text(
                                        egp(delta.abs()),
                                        style: TextStyle(
                                          color: delta < 0 ? teal : const Color(0xFFA33624),
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (v) {
                    ...
                    if (minor == null || minor <= 0) return 'أدخل مبلغاً صحيحاً.';
                    if (minor > widget.balanceMinor) return 'المبلغ أكبر من الرصيد.';
                    return null;
                  },
                ),
                const SizedBox(height: 16),
